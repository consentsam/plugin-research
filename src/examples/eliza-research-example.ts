...
export const researchAgentConfig = {
  ...
  plugins: [
    ...
    "@elizaos/plugin-browserbase", // Optional but recommended
...
const example1 = {
  ...
  agent: "I'll start researching the latest AI breakthroughs in 2024 for you. Let me conduct a comprehensive search and analysis.",
  // Agent internally calls: start_research action
  result: "Research project started with ID: abc-123. I'm now searching for information, analyzing sources, and will compile a detailed report."
};
...
const example2 = {
  ...
  result: "Your research on 'latest AI breakthroughs in 2024' is 60% complete. Currently in the analyzing phase. I've found 15 sources and am processing the findings."
};
...
const example4 = {
  ...
  result: "Starting DeFi-focused research on yield farming strategies. I'll analyze protocols, APYs, risks, and provide actionable insights."
};
 ...
 *    - Uses Google instead of DuckDuckGo
 * 
